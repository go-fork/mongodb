...
## Download
- Source code: [go.fork.vn/mongodb@$target_version]
- Documentation: [pkg.go.dev/go.fork.vn/mongodb@$target_version]
...
\`\`\`bash
go get go.fork.vn/mongodb@$target_version
go mod tidy
\`\`\`
...
## Getting Help
- Check the [documentation](https://pkg.go.dev/go.fork.vn/mongodb@$target_version)
